...
class CoSTEncoder(nn.Module):
    def __init__(self, input_dims, output_dims,
        ...
        self.grn = GatedResidualNetwork(input_size=input_dims, hidden_size=hidden_dims, output_size=hidden_dims)
    ...
    def forward(self, x, tcn_output=False, mask='all_true'):  # x: B x T x input_dims
        ...
        x = self.nfd(pure_x)
        noisy = x - self.repr_dropout(season) - trend
        trend = trend - noisy
        season = season - noisy
